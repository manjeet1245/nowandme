...
export default function HandleLogin(){
    const { isModalOpen } = UseContext()

    return(

        <>
        {
            {isModalOpen} ?  <LoginHome/> : <LoginStart/>
        }
        </>
    )
...
const LoginHome = () => {
    return (
        <div>
            ...
            <img src={Logo} alt="" className='absolute left-2/4'/>
        ...
        <main className='absolute top-2/4 left-2/4  -translate-x-2/4 -translate-y-2/4  '>
            ...
            <div className='rounded p-9  bg-grey-800 border-solid border-2'>
                <div className=' text-center px-20 py-8 m-5 '>
                ...
                <form className='pt-2 '>
                    ...
                    <input
                        ...
                        className='text-gray-500 p-2 bg-transparent  rounded-md border-solid border-2 border-gray-500 min-w-full
                             '
                    />
                    <label className='block text-gray-600 pt-3'>
